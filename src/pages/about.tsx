...
export default function About() {
  return (
    <>
      ...
      >
        <div className="text-2xl md:text-5xl text-center text-white" style={{ textShadow: "2px 2px 6px rgba(0,0,0,0.9)" }}>
          Your Neighbourhood Coffee Haven
        </div>

        <div className="px-3 py-2 text-xs md:text-3xl lg:text-4xl xl:text-2xl text-center text-white max-w-2xl" style={{ textShadow: "2px 2px 6px rgba(0,0,0,0.9)" }}>
